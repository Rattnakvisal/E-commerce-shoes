...
function login_set_session_and_cookie(PDO $conn, array $user): void
{
    ...
    // Backward compatible/session keys used elsewhere
...
function redirect_by_role(string $role): void
{
    ...
    // Build a host-correct base URL (works on localhost and other hosts)
    $scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') || (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] === 'https')
        ? 'https' : 'http';
