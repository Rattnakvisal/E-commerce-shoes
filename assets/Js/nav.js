...
document.addEventListener('click', (e) => {
    if (messagesDropdown && !messagesButton?.contains(e.target) && !messagesDropdown.contains(e.target)) {
        messagesDropdown.classList.add('hidden');
    }

    if (quickAddDropdown && !quickAddButton?.contains(e.target) && !quickAddDropdown.contains(e.target)) {
        quickAddDropdown.classList.add('hidden');
    }

    if (adminDropdownMenu && !adminDropdownButton?.contains(e.target) && !adminDropdownMenu.contains(e.target)) {
        adminDropdownMenu.classList.add('hidden');
    }
});
