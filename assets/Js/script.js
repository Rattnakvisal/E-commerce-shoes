document.addEventListener("DOMContentLoaded", () => {
  ...
  $(".mobile-parent").forEach((parent) => {
    ...
    toggle?.addEventListener("click", () => {
      ...
      $(".mobile-submenu").forEach(
        (s) => s !== submenu && smoothToggle(s, false),
      );
      $(".mobile-parent .fa-chevron-right").forEach(
        (a) => a !== arrow && a.classList.remove("rotate-90"),
      );
