    ...
    <main class="md:ml-64 p-4 md:p-6">
        ...
        <div class="mb-6 animate-fade-in">
            <div class="flex flex-col md:flex-row md:items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Slides Management</h1>
                    <p class="text-gray-600 mt-1">Manage your home page slides</p>
                </div>
                <div class="mt-4 md:mt-0 flex space-x-3">
                    <button onclick="openAddModal()" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300">
        ...
        <div class="table-container">
            ...
            <div class="filter-section">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-semibold text-gray-900">Filter Slides</h2>
                </div>
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="order" class="form-control">
                            ...
                            <option value="asc" <?php echo (isset($_GET['order']) && $_GET['order'] === 'asc') ? 'selected' : ''; ?>>Lowest First</option>
                            <option value="desc" <?php echo (isset($_GET['order']) && $_GET['order'] === 'desc') ? 'selected' : ''; ?>>Highest First</option>
                        </select>
                    </div>

                    <div class="flex items-end space-x-2 pt-6">
                        <button type="submit" class="btn bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300 w-full">
                            Apply
                        </button>
