                        ...
                        <div>
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-900">
                                    Products <span class="gradient-text">Management</span>
                                </h1>
                            </div>

                            <p class="text-gray-600 text-sm sm:text-base max-w-2xl">
                                Manage, organize, and track all products in your store with full control.
                            </p>

                            <!-- Meta (optional but looks premium) -->
