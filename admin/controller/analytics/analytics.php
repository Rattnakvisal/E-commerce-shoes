                    ...
                    <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm sm:text-base max-w-2xl">
                                Comprehensive overview of store performance, trends, and key metrics.
                            </p>
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            <form method="GET" class="flex flex-wrap items-center gap-2">
                                ...
                                <select
                                    ...
                                    class="border rounded-xl px-4 py-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-black/20">
                                ...
                                <?php if ($dateRange === 'custom'): ?>
                                    <input
                                        ...
                                        class="border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-black/20"
                                        required>
                                    ...
                                    <button
                                        type="submit"
                                        class="inline-flex items-center gap-2 rounded-2xl bg-black text-white px-5 py-2.5 text-sm font-semibold shadow hover:opacity-90 transition">
