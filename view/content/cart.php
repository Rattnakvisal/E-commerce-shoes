    ...
    <main class="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <section class="lg:col-span-2">
            ...
            <?php if (!$products): ?>
                ...
                <a href="../../view/content/products.php"
    ...
    <section class="max-w-7xl mx-auto px-6 pb-16">
        <div class="mt-20 border-t pt-14">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <!-- Feature 1 -->
                <div class="group rounded-2xl p-6 border bg-white transition-all duration-300
                    ...
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 mb-4
                        ...
                        <i class="fas fa-truck text-gray-900 transition-all duration-300 group-hover:text-white"></i>
                    </div>
                    <h3 class="font-semibold mb-2 text-gray-900">Free Shipping</h3>
                    <p class="text-sm text-gray-600">Free standard shipping on all orders over $50.</p>
                </div>
                ...
                <div class="group rounded-2xl p-6 border bg-white transition-all duration-300
                    ...
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 mb-4
                            transition-all duration-300 group-hover:bg-black">
                        <i class="fas fa-rotate-left text-gray-900 transition-all duration-300 group-hover:text-white"></i>
                    </div>
                    <h3 class="font-semibold mb-2 text-gray-900">Easy Returns</h3>
                    <p class="text-sm text-gray-600">30-day hassle-free returns on unworn items.</p>
                </div>
                ...
                <div class="group rounded-2xl p-6 border bg-white transition-all duration-300
                    ...
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 mb-4
                            transition-all duration-300 group-hover:bg-black">
                        <i class="fas fa-lock text-gray-900 transition-all duration-300 group-hover:text-white"></i>
                    </div>
                    <h3 class="font-semibold mb-2 text-gray-900">Secure Checkout</h3>
                    <p class="text-sm text-gray-600">Your payment information is processed securely.</p>
                </div>
                ...
                <div class="group rounded-2xl p-6 border bg-white transition-all duration-300
                    ...
                    <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 mb-4
                            transition-all duration-300 group-hover:bg-black">
                        <i class="fas fa-star text-gray-900 transition-all duration-300 group-hover:text-white"></i>
                    </div>
                    <h3 class="font-semibold mb-2 text-gray-900">Member Benefits</h3>
                    <p class="text-sm text-gray-600">Join members for exclusive offers & rewards.</p>
                </div>
            </div>
        </div>
    </section>
