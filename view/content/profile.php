...
<body class="bg-gray-50 text-gray-900">
    ...
    <main class="max-w-6xl mx-auto px-4 py-10 sm:py-12">
        ...
        <!-- Header -->
        <section class="rounded-3xl overflow-hidden border bg-gradient-to-br from-black via-gray-900 to-gray-800">
        ...
        <?php if ($flash): ?>
            <div class="mt-6 rounded-2xl border bg-white p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-bold"><?= $isError ? 'Notice' : 'Success' ?></p>
                ...
                <div class="p-6">
                    ...
                    <div class="mt-6 space-y-3 text-sm">
                        ...
                        <div class="flex items-center justify-between gap-3 rounded-2xl border bg-gray-50 px-4 py-3">
                            ...
                            <span class="font-bold text-gray-900">#<?= e($user['user_id'] ?? '') ?></span>
                        </div>
                ...
                <div class="bg-white border rounded-3xl">
                    <div class="p-6 sm:p-8">
                        ...
                        <form action="/MyBrand_Ecommerce/view/actions/profile_update.php" method="post"
                            ...
                            <div>
                                <label for="phone" class="block text-sm font-bold mb-1">Phone</label>
                            ...
                            <div class="sm:col-span-2 flex flex-col sm:flex-row gap-3 pt-2">
                                <button type="submit"
                                    class="px-5 py-3 rounded-full bg-black text-white font-bold hover:bg-gray-900">
                                    Save Changes
                                </button>
                ...
                <div class="bg-white border rounded-3xl">
                    <div class="p-6 sm:p-8">
                        ...
                        <form action="/MyBrand_Ecommerce/view/actions/profile_update.php" method="post"
                            ...
                            <div class="sm:col-span-2">
                                <label for="current_password" class="block text-sm font-bold mb-1">Current Password</label>
                            ...
                            <div>
                                <label for="new_password" class="block text-sm font-bold mb-1">New Password</label>
                            ...
                            <div>
                                <label for="confirm_password" class="block text-sm font-bold mb-1">Confirm New Password</label>
